	...
	return []featuredPostData{
		{
			...
			Subtitle:     "The road ahead might be paved - it might not be.",
			Author:       "Mat Vogels",
			AuthorImg:    "../static/images/IMAGE1.jpg",
			PublishDate:  "September 25, 2015",
			ButMod:       "",
			But:          "",
			ImgModifier:  "images_first",
			ImgModifier2: "images__title",
		},
		{
			Title:        "From Top Down",
			Subtitle:     "Once a year, go someplace you've never seen before.",
			Author:       "William Wong",
			AuthorImg:    "../static/images/IMAGE2.jpg",
			PublishDate:  "September 25, 2015",
			ButMod:       "images__button",
			But:          "Adventure",
			ImgModifier:  "images_second",
			ImgModifier2: "images__title2",
		},
	}
}
	...
	return []recentPostData{
		{
			...
			ImgMain:     "../static/images/IMAGE3.jpg",
			Author:      "William Wong",
			AuthorImg:   "../static/images/IMAGE2.jpg",
		...
		},
		{
			...
			ImgMain:     "../static/images/IMAGE4.png",
			Author:      "Mat Vogels",
			AuthorImg:   "../static/images/IMAGE1.jpg",
			PublishDate: "9/25/2015",
			AuthorMod:   "container1__name_author_mat",
		},
		{
			Title:       "Water Falls",
			Subtitle:    "We travel not to escape life, but for life not to escape us",
			ImgMain:     "../static/images/IMAGE5.png",
			Author:      "Mat Vogels",
			AuthorImg:   "../static/images/IMAGE1.jpg",
			PublishDate: "9/25/2015",
			AuthorMod:   "container1__name_author_mat",
		},
		{
			...
			ImgMain:     "../static/images/IMAGE6.png",
			Author:      "William Wong",
			AuthorImg:   "../static/images/IMAGE2.jpg",
			PublishDate: "9/25/2015",
			AuthorMod:   "",
		},
		{
			...
			ImgMain:     "../static/images/IMAGE7.png",
			Author:      "Mat Vogels",
			AuthorImg:   "../static/images/IMAGE1.jpg",
			PublishDate: "9/25/2015",
			AuthorMod:   "container1__name_author_mat",
		},
		{
			...
			ImgMain:     "../static/images/IMAGE8.png",
			Author:      "Mat Vogels",
			AuthorImg:   "../static/images/IMAGE1.jpg",
			PublishDate: "9/25/2015",
			AuthorMod:   "container1__name_author_mat",
